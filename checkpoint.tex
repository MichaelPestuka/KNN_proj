...
\section{ControlNet based apoproach}
\label{controlnet}
...
% I WILL REDO THIS VALIDATION TOMMOROW ON BOTH THE OG DATA 250k AND SECOND GEN GAMENGEN MODEL

\section{Future work}

Currently we are focusing on re-running our training with the update dataset. If this section hasn't been updated with the results then something probably went wrong.

Further I would like to explore training a smaller, purpose-built transformer ground-up to achieve better performance on more reasonable hardware, like a laptop GPU.

I encourage my collegues to add to this section ofcourse.
