...
We have employed both PSNR and LPIPS in an evaluation script. We have also relied heavily on the interactive mode during development to better understand model behaviour. The displayed in Figure \ref{fig:real-gameplay-eval} is a capture of real user gameplay inputs, comparing the output of the real game and various model checkpoints TODO. A side by side GIF of the ground truth and generated frames is available at these permalinks to GitHub ... TODO
