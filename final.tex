...
The displayed in Figure \ref{fig:real-gameplay-eval} is the output of the script based on a capture of real user gameplay inputs, comparing the output of the real game and various model checkpoints TODO. A side by side GIF of the ground truth and generated frames is available at these permalinks to GitHub ... TODO
...
GAMENGEN ACHIVEVED LPIPS 0,198 @ 4 iterations, 0,205 @ 2 iterations. `sd-mario-3' achieves 0.195402 TBF our standard deviation is larger but whatever. The PSNR is not as good, but we consider this less indicative.

We hope to present a playable demo at the poster session.
