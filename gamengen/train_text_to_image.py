...
def main():
    ...
    if args.load_pretrained:
        ...
        action_embedding.load_state_dict(
            load_file(os.path.join(args.load_pretrained, "action_embedding_model.safetensors"))
        )


        #action_embedding.num_embeddings = 12
        #action_embedding.embedding_dim = 768
    ...
    vae.load_state_dict(
            load_file(
                os.path.join(
                    "big_better_enc", "vae", "diffusion_pytorch_model.safetensors"
                )
            )
        )
                            ...
                            wandb.log(
                                {
                                    ...
                                    "3_context_images": [
                                        ...
                                        for i, context_img in enumerate(context_images[0])
                                    ],
                                },
                                step=global_step,
                            )
